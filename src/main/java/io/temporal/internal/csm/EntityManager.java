...
public final class EntityManager {
   ...
   */
  private final Queue<NewCommand> commands = new LinkedList<>();
  ...
  public EntityManager(CommandsManagerListener callbacks) {
    ...
    sink = (command) -> commands.add(command);
  }
  ...
  public void handleCommand(HistoryEvent event) {
    ...
    System.out.println(" takeCommand commands.put " + event.getEventId() + ", command=" + command);
  }
  ...
  private void prepareCommands() {
    ...
    //
    List<NewCommand> filteredCommands = new ArrayList<>(commands.size());
    while (true) {
      NewCommand newCommand = commands.poll();
      if (newCommand == null) {
        break;
      }
