...
public final class MutableSideEffectStateMachine
    extends EntityStateMachine<
        ...
        MutableSideEffectStateMachine.Action,
  ...
  public static void newInstance(
    ...
    new MutableSideEffectStateMachine(id, replaying, result, func, callback, commandSink);
  }
  ...
  private static StateMachine<State, Action, MutableSideEffectStateMachine> newStateMachine() {
    return StateMachine.<State, Action, MutableSideEffectStateMachine>newInstance(
            "MutableSideEffect",
            State.CREATED,
        ...
        .add(
            ...
            MutableSideEffectStateMachine::createMarkerCommand)
        .add(
            State.MARKER_COMMAND_CREATED,
            CommandType.COMMAND_TYPE_RECORD_MARKER,
            State.MARKER_COMMAND_CREATED,
            MutableSideEffectStateMachine::notifyResult)
        .add(
            State.CANCELLED_MARKER_COMMAND_CREATED,
            CommandType.COMMAND_TYPE_RECORD_MARKER,
            State.MARKER_CANCELLED,
            MutableSideEffectStateMachine::notifyCachedResult)
        .add(
            State.MARKER_COMMAND_CREATED,
        ...
        .add(
            ...
            State.MARKER_COMMAND_RECORDED,
            MutableSideEffectStateMachine::markerResultFromEvent);
  }
