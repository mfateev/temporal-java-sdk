...
public final class WorkflowCommands
    extends CommandsBase<WorkflowCommands.State, WorkflowCommands.Action, WorkflowCommands> {
  ...
  private static StateMachine<State, Action, WorkflowCommands> newStateMachine() {
    return StateMachine.<State, Action, WorkflowCommands>newInstance(
        ...
        .add(
            ...
            WorkflowCommands::cancelRequested)
  ...
  public static void newInstance(
    ...
    new WorkflowCommands(cancellationCallback, commandSink);
  }
