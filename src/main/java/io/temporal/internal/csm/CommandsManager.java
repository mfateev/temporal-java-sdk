...
public final class CommandsManager {
  ...
  private List<Command> preparedCommands;
  ...
  public List<Command> takeCommands() {
    List<Command> result = preparedCommands;
  ...
  private void prepareCommands() {
    ...
    for (NewCommand newCommand : newCommands) {
      ...
      if (command.isPresent()) {
        preparedCommands.add(command.get());
    ...
    if (isReplaying()) {
      ...
      RecordMarkerCommandAttributes attributes =
          RecordMarkerCommandAttributes.newBuilder()
              ...
              .build();
      MarkerCommands.newInstance(
          attributes, (event) -> callback.apply(result, null), callbacks::eventLoop, sink);
    }
  }
