...
public class MarkerUtils {
   ...
   * values are converted using the core payload converter.
   *
   * @param markerAttributes marker attributes to extract the value from
   ...
   * @return the value deserialized using the core payload converter
   */
  @Nullable
