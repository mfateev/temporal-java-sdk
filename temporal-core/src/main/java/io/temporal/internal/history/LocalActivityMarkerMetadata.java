...
/**
 * Metadata for local activity markers.
 *
 * <p>See <a
 ...
 * Data Structure</a>
 *
 * <p>JSON field names for serialization:
 *
 * <ul>
 *   <li>originalScheduledTimestamp → "firstSkd"
 *   <li>attempt → "atpt"
 *   <li>backoff → "backoff" (as milliseconds)
 * </ul>
 */
public class LocalActivityMarkerMetadata {
  ...
  @Nullable private Duration backoff;
