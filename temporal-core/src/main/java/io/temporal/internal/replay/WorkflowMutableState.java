...
public class WorkflowMutableState {
  ...
  public WorkflowMutableState(WorkflowExecutionStartedEventAttributes startedAttributes) {
  ...
  public void continueAsNewOnCompletion(
      ContinueAsNewWorkflowExecutionCommandAttributes parameters) {
